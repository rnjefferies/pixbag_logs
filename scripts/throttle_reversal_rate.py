...
def plot_throttle(data, reversals, output_path):
    ...
    plt.title('Throttle with Reversals Highlighted')
    plt.grid(True)
...
def process_all_participants_data(data_logs_dir):
    ...
    results_df.to_csv(os.path.join(data_logs_dir, 'joystick_throttle_reversals_summary.csv'), index=False)
...
def process_single_file(file_path):
    ...
    plot_throttle(data, reversals, output_path=file_path.replace('.csv', '.png'))
